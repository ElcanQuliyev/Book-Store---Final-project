document.addEventListener("DOMContentLoaded", () => {
    ...
    if (prevButton2) prevButton2.style.display = "none";
    if (nextButton2) nextButton2.style.display = "none";

    let notFoundMessage2 = productContainer2.parentElement.querySelector(".not-found-2");
    if (!notFoundMessage2) {
        notFoundMessage2 = document.createElement("div");
        notFoundMessage2.classList.add("not-found-2"); 
    ...
    function filterBooks2() {
        ...
        notFoundMessage2.style.display = found2 === 0 ? "block" : "none";
    }
